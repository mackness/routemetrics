...
function Map() {
  this.mapReady = !1, this.tracking = !1, this.roughCoords = [], this.snappedCoords = [], this.watch = "", this.speed = 0, this.distance = 0, this.key = "AIzaSyAOraoCS2YWp6ogkhbS8DvY88y-7H6zAdg", this.geolocation = "geolocation" in navigator, this.elements = { mapContainer: document.querySelector("#map"), body: document.body }, this.init();
  ...
  var t = new google.maps.DistanceMatrixService();t.getDistanceMatrix({ origins: [this.roughCoords[0]], destinations: [this.roughCoords[this.roughCoords.length - 1]], travelMode: "BICYCLING", unitSystem: google.maps.UnitSystem.IMPERIAL, avoidHighways: !1, avoidTolls: !1 }, function (t, e) {
  ...
  var t = document.createElement("div");t.classList.add("data-panel"), t.appendChild(this.stopwatchElement()), t.appendChild(this.speedElement()), t.appendChild(this.distanceElement()), this.insertMapElement(t, "BOTTOM_RIGHT");
}, Map.prototype.init = function () {
  this.tracking ? this.watchPosition(function (t) {
    var e = new google.maps.LatLng(t.latitude, t.longitude),
        n = new google.maps.LatLng(t.latitude - 8e-4, t.longitude);this.roughCoords.push(e), this.elements.speedElement.innerHTML = t.speed || 0, this.roughCoords.length % 10 == 0 && (this.snapToRoads(), this.calculateDistance()), this.drawPloyline(), this.map.panTo(n), this.speedElement();
  }.bind(this), function (t) {
    console.log("error", t);

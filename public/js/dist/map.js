...
function Map() {
  ...
  var t = document.createElement("div"),
      e = document.createElement("div"),
      n = document.createElement("span");return n.innerHTML = "distance: ", n.classList.add("data-panel__label"), e.classList.add("data-panel__row"), t.classList.add("data-panel__distance"), e.appendChild(n), e.appendChild(t), t.innerHTML = this.distance + " (km)", this.elements.distanceElement = t, e;
}, Map.prototype.elevationElement = function () {
  var t = document.createElement("div"),
      e = document.createElement("div"),
      n = document.createElement("span");return n.innerHTML = "elevation: ", n.classList.add("data-panel__label"), e.classList.add("data-panel__row"), t.classList.add("data-panel__elevation"), e.appendChild(n), e.appendChild(t), t.innerHTML = this.elevation || "0 (m)", this.elements.elevationElement = t, e;

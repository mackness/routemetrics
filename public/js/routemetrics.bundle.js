...
/***/ function(module, exports, __webpack_require__) {
	...
	if (document.getElementById('outlet')) {
		_reactDom2.default.render(_react2.default.createElement(_Map2.default, null), document.getElementById('outlet'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _debugger = __webpack_require__(170);

	var _TrackingButton = __webpack_require__(171);
	...
	var Map = function (_Component) {
	  ...
	  _createClass(Map, [{
	    ...
	    value: function _processRoughCoordinates(map, data) {
	      this.state.roughCoordinates.push(data);
	      this._drawRoughPolyline(map);
	    }
	  }, {
	    key: '_watchPosition',
	    value: function _watchPosition(map, marker) {
	      var _this2 = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TrackingButton = function (_Component) {
	  _inherits(TrackingButton, _Component);

	  function TrackingButton(props) {
	    _classCallCheck(this, TrackingButton);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TrackingButton).call(this, props));
	...
	exports.default = TrackingButton;

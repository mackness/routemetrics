...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TrackingButton = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/TrackingButton\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    ...
	    value: function componentDidMount() {
	      ...
	      if (navigator.geolocation) {
	        navigator.geolocation.getCurrentPosition(function (pos) {
	          ...
	          _this2._setInitialPosition(map, pos);
	          _this2._watchPosition(map, marker);
	        }, function (err) {
